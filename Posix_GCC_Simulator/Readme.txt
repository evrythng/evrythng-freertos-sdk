Posix GCC Eclipse FreeRTOS 5.4.2 Simulator
...
Build Instructions
	...
	Optional:
		Eclipse Ganymede
		CDT 4.0
		Eclipse STATEVIEWER Plug-in v1.0.6
...
work to be done). The two AsyncIO examples that have been provided are Posix Message Queues 
and UDP sockets.
...
In theory, the code provided for the UDP AsyncIO can be extended to provide asynchronous IO on 
all file descriptors that support it. For example, it should be possible to extend it to provide
AsyncIO on the serial port.
